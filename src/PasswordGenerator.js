...
const PasswordGenerator = () => {
  ...
  const themes = {
    default: '',
    bird: ['Eagle', 'Sparrow', 'Robin', 'Falcon', 'Parrot', 'Eagle123!',
    'Sparrow@2023',
    'Falcon#Power',
    'Hawk$Force2024',
    'Owl*W1sdom!',
    ...
    'Phoenix#2025Pass',
    'Vulture$Strong!'],
    country: ['Canada', 'India', 'France', 'Brazil', 'Japan','Canada2023!',
    'India$Secur3',
    'France#2024P@ss',
    'Brazil&Auth3ntic',
    'Japan*Safe2025',
    ...
    'Greece#2029!Safe',
    'Argentina$Strong2!'],
    name: ['Alice', 'Bob', 'Charlie', 'Diana', 'Edward','Ananya@2023Pass',
    'Bhavya#S3cure!',
    'Chirag*2024Pass',
    'Devika$Str0ng!',
    'Esha!Saf3@2025',
    ...
    'Naina$Auth3nt1c',
    'Omkar@2030S3cure'],
    easy: ['password', '123456', 'abcdef', 'letmein', 'welcome','password@2023!',
    '123456#Secur3',
    'abcdef*2024P@ss',
    'letmein$Str0ng!',
    'welcome!2025Saf3',
